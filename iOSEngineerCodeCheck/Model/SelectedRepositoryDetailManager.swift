...
//
//        let selectedRepositoryDetail = RepositoryDetailModel(title: title, language: language, starsCount: stars, watchersCount: watchers, forksCount: forks, openIssuesCount: openIssue, avatarImageURL: avatarImageURL)
//
